...
net_opt['use_avg_on_conv3'] = False
networks = {}
optim = {'lr': 1e-4, 'momentum':0.9, 'weight_decay': 5e-4}
networks['model'] = {'def': 'NetworkInNetwork', 'optim_type': 'sgd', 'pretrained': None, 'opt': net_opt, 'optim_params': optim}
config['networks'] = networks

config['model'] = 'RotNet'
config['max_num_epochs'] = 50
config['loader_args'] = {'batch_size': batch_size, 'shuffle': True, 'num_workers': 0}
config['loader'] = 'RotateDataLoader'
config['dataset'] = {}