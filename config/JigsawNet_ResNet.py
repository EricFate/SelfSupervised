...
net_opt = {}
net_opt['num_classes'] = 24
net_opt['perm'] = 2
net_opt['num_hidden'] = 64
networks = {}
optim = {'lr': 1e-4, 'weight_decay': 5e-4}
networks['model'] = {'def': 'ResJigsawNet', 'optim_type': 'adam', 'pretrained': None, 'opt': net_opt,
                     'optim_params': optim}
config['networks'] = networks

config['model'] = 'Jigsaw'
config['max_num_epochs'] = 50
config['loader_args'] = {'perm': 2, 'batch_size': batch_size, 'shuffle': True, 'num_workers': 0}
config['loader'] = 'JigsawDataLoader'
config['dataset'] = {}
# *************downstream config****************
